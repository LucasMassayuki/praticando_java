...
public class Worker {
	...
	// Como trabalhador ganhou no ano e mês, somando o salario base com contrato
	public double income(int year, int month) {// contrato com "desse mês e ano"
		...
		for (HourContract c : contracts) {// para cada contrato c na listinha de contracts
			...
			int c_month = 1 + cal.get(Calendar.MONTH);//o mês do catranto "c"
